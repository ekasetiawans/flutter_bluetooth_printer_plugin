...
public class FlutterBluetoothPrinterPlugin: NSObject, FlutterPlugin, FlutterStreamHandler, PrinterManagerDelegate {


    static var instance: FlutterBluetoothPrinterPlugin?
